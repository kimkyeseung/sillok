...
CREATE TABLE person_node_links (
  ...
  link_type TEXT,
  portrayed_by TEXT,            -- MEDIA links: actor who played this person
...
CREATE TABLE threads (
  ...
  category    TEXT NOT NULL DEFAULT 'DISCUSSION'
              CONSTRAINT threads_category_check
...
-- ============================================================
-- Phase 3: community features (polls, personal status, suggestions)
-- ============================================================
