...
export default function AdminPersonRequestsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Person Addition Requests</h1>
        <p className="mt-0.5 text-sm text-gray-500">List of user-requested person additions</p>
      </div>
